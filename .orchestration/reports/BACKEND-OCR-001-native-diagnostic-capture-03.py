...
directory = root / ".orchestration/reports/BACKEND-OCR-001-native-diagnostic-evidence-03"
...
data["context_sha256"] = {
    ...
    for path in (".env", "backend/.env", "pyproject.toml", "backend/Dockerfile",
                 ...
                 ".orchestration/reports/BACKEND-OCR-001-native-diagnostic-windows-03.py",
