...
TEST_LF = "52349c96c31b6c373d8d8c99471b21df64ea5dea4a0a77f52539a884492e0f02"
...
def source_pins(path, digest):
    ...
    required = {TEST, "backend/app/workers/ocr_containment.py", "backend/app/workers/ocr.py",
...
def inner(args):
    ...
    os.execv(sys.executable, [sys.executable, "-m", "pytest", NODE, "-q", "--tb=short",
